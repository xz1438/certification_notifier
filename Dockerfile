...
RUN git clone https://github.com/amalivert/certification_notifier.git && cd certification_notifier && git checkout dev && python3 -m pip -r requirements.txt && python3 -m pip install -r requirements.txt
